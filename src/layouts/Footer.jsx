        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-4 mt-2">
              <a href="https://anisul770.netlify.app/" target="_blank" rel="noopener noreferrer" className="p-2 bg-base-200 rounded-lg hover:bg-primary hover:text-white transition-all duration-300">
                <Globe size={18} />
              </a>
              <a href="https://github.com/anisul770/" target="_blank" rel="noopener noreferrer" className="p-2 bg-base-200 rounded-lg hover:bg-primary hover:text-white transition-all duration-300">
                <Github size={18} />
              </a>
              <a href="https://leetcode.com/u/anisul770/" target="_blank" rel="noopener noreferrer" className="p-2 bg-base-200 rounded-lg hover:bg-primary hover:text-white transition-all duration-300">
                <Code2 size={18} />
              </a>
              <a href="https://www.linkedin.com/in/anisul770/" target="_blank" rel="noopener noreferrer" className="p-2 bg-base-200 rounded-lg hover:bg-primary hover:text-white transition-all duration-300">
                <Linkedin size={18} />
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <form onSubmit={handleSubmit(onSubscribe)} className="flex flex-col gap-2">
              <div className="relative group">
                ...
                />
                <button type="submit" className="absolute right-2 top-1 btn btn-primary btn-sm rounded-lg">
                  <Send size={14} />
                </button>
              </div>
